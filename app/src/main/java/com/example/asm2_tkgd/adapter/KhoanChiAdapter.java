...
public class KhoanChiAdapter extends BaseAdapter {
    ...
    public KhoanChiAdapter(ArrayList<KhoanThuChi> list, Context context, KhoanThuChiDAO khoanThuChiDAO, ArrayList<HashMap<String, Object>> listSpinner) {
        this.list = list;
    ...
    private void showDialogSuaKhoanThuChi(KhoanThuChi khoanThuChi) {
        ...
        Spinner spnLoaiThuChi = view.findViewById(R.id.spnLoaiChi);
